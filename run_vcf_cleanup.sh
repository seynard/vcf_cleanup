...
run='diagnostic' 
########################################################################################################## 
sbatch -W -J vcf_cleanup_${run}1 -o ${DIROUT}/log/vcf_cleanup_${run}1.o -e ${DIROUT}/log/vcf_cleanup_${run}1.e --wrap="${SCRIPTS}/vcf_cleanup.sh ${username} ${SCRIPTS} ${DIRIN} ${DIROUT} ${VCFIN} ${limit_allele} ${limit_FS} ${limit_SOR} ${limit_MQ} ${limit_MQRankSum} ${limit_ReadPosRankSum} ${limit_QUAL} ${limit_QD} ${limit_GQ} ${limit_miss} ${limit_het} ${limit_GQfiltered} ${quantile_prob_above_threshold} ${quantile_prob_below_threshold} ${kept_above_threshold} ${kept_below_threshold} ${run} ${type}" 
rename plot_decision_ plot_decision_${run}1 ${dir_out}/plot_decision_*.pdf
rename _value _value_${run}1 ${dir_out}/*_value.txt
...
run='diagnostic' 
########################################################################################################## 
sbatch -W -J vcf_cleanup_${run}2 -o ${DIROUT}/log/vcf_cleanup_${run}2.o -e ${DIROUT}/log/vcf_cleanup_${run}2.e --wrap="${SCRIPTS}/vcf_cleanup.sh ${username} ${SCRIPTS} ${DIRIN} ${DIROUT} ${VCFIN} ${limit_allele} ${limit_FS} ${limit_SOR} ${limit_MQ} ${limit_MQRankSum} ${limit_ReadPosRankSum} ${limit_QUAL} ${limit_QD} ${limit_GQ} ${limit_miss} ${limit_het} ${limit_GQfiltered} ${quantile_prob_above_threshold} ${quantile_prob_below_threshold} ${kept_above_threshold} ${kept_below_threshold} ${run} ${type}" 
rename plot_decision_ plot_decision_${run}2 ${dir_out}/plot_decision_*.pdf
rename _value _value_${run}2 ${dir_out}/*_value.txt
...
run='filter_all' 
########################################################################################################## 
sbatch -W -J vcf_cleanup_${run} -o ${DIROUT}/log/vcf_cleanup_${run}.o -e ${DIROUT}/log/vcf_cleanup_${run}.e --wrap="${SCRIPTS}/vcf_cleanup.sh ${username} ${SCRIPTS} ${DIRIN} ${DIROUT} ${VCFIN} ${limit_allele} ${limit_FS} ${limit_SOR} ${limit_MQ} ${limit_MQRankSum} ${limit_ReadPosRankSum} ${limit_QUAL} ${limit_QD} ${limit_GQ} ${limit_miss} ${limit_het} ${limit_GQfiltered} ${quantile_prob_above_threshold} ${quantile_prob_below_threshold} ${kept_above_threshold} ${kept_below_threshold} ${run} ${type}" 

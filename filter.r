...
#first venn (mapping quality filter)
filter_list<-c('FS','SOR','MQ','MQRankSum','ReadPosRankSum')
name_f1<-name_filter(filter_list,filter_info$filt,filter_info$Filt,filter_info$info,info,'none',NA)
plot_venn1<-plot_venn(filter_list,f_list1,name_f1,'none',NA)
#second venn quality
filter_list<-c('QUAL','QD')
name_f2<-name_filter(filter_list,filter_info$filt,filter_info$Filt,filter_info$info,info,'int1',int1)
plot_venn2<-plot_venn(filter_list,f_list2,name_f2,'int1',int1)
#third venn allele
filter_list<-c('allele','miss','het','GQfiltered')
